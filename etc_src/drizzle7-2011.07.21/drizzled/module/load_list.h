...
#define PANDORA_PLUGIN_LIST "version,uuid_function,syslog,substr_functions,show_schema_proto,reverse_function,rand_function,multi_thread,md5,logging_stats,length,hex_functions,errmsg_stderr,default_replicator,crc32,connection_id,compression,charlength,benchmark,ascii,"
